...
_lr_productions = [
  ...
  ('more_vars -> vars','more_vars',1,'p_more_vars','ObsidianParser.py',19),
  ('more_vars -> <empty>','more_vars',0,'p_more_vars','ObsidianParser.py',20),
  ('vars -> var_type vars_aux SEMICOLON more_vars','vars',4,'p_vars','ObsidianParser.py',23),
  ('var_type -> BOOL','var_type',1,'p_var_type','ObsidianParser.py',26),
  ('var_type -> INT','var_type',1,'p_var_type','ObsidianParser.py',27),
  ('var_type -> DOUBLE','var_type',1,'p_var_type','ObsidianParser.py',28),
  ('vars_aux -> ID arr to_var_table var_assign more_vars_aux','vars_aux',5,'p_vars_aux','ObsidianParser.py',33),
  ('to_var_table -> <empty>','to_var_table',0,'p_to_var_table','ObsidianParser.py',37),
  ('var_assign -> EQUALS var_cte','var_assign',2,'p_var_assign','ObsidianParser.py',41),
  ('var_assign -> <empty>','var_assign',0,'p_var_assign','ObsidianParser.py',42),
  ...
  ('func_type -> VOID','func_type',1,'p_func_type','ObsidianParser.py',78),
  ('func_type -> BOOL','func_type',1,'p_func_type','ObsidianParser.py',79),
  ('func_type -> INT','func_type',1,'p_func_type','ObsidianParser.py',80),
  ('func_type -> DOUBLE','func_type',1,'p_func_type','ObsidianParser.py',81),
  ('arguments -> var_type ID to_args more_args','arguments',4,'p_arguments','ObsidianParser.py',85),
  ('arguments -> <empty>','arguments',0,'p_arguments','ObsidianParser.py',86),
  ('more_args -> COMMA var_type ID to_args more_args','more_args',5,'p_more_args','ObsidianParser.py',90),
  ('more_args -> <empty>','more_args',0,'p_more_args','ObsidianParser.py',91),
  ('to_args -> <empty>','to_args',0,'p_to_args','ObsidianParser.py',94),
  ('func_block -> LBRACKET more_vars actual_quad_no more_statement gen_endproc_quad RBRACKET','func_block',6,'p_func_block','ObsidianParser.py',101),
  ('actual_quad_no -> <empty>','actual_quad_no',0,'p_actual_quad_no','ObsidianParser.py',104),
  ('gen_endproc_quad -> <empty>','gen_endproc_quad',0,'p_gen_endproc_quad','ObsidianParser.py',109),
  ...
  ('statement -> return_stmt','statement',1,'p_statement','ObsidianParser.py',120),
  ('statement -> cycle','statement',1,'p_statement','ObsidianParser.py',121),
  ('statement -> condition','statement',1,'p_statement','ObsidianParser.py',122),
  ('statement -> assignation','statement',1,'p_statement','ObsidianParser.py',123),
  ('statement -> func_call SEMICOLON','statement',2,'p_statement','ObsidianParser.py',124),
  ('read -> READ LPAR ID to_pilaOp arr_par RPAR gen_read_quad SEMICOLON','read',8,'p_read','ObsidianParser.py',127),
  ('gen_read_quad -> <empty>','gen_read_quad',0,'p_gen_read_quad','ObsidianParser.py',130),
  ('write -> WRITE LPAR exp RPAR gen_write_quad SEMICOLON','write',6,'p_write','ObsidianParser.py',135),
  ('gen_write_quad -> <empty>','gen_write_quad',0,'p_gen_write_quad','ObsidianParser.py',138),
  ('return_stmt -> RETURN exp gen_return_quad SEMICOLON','return_stmt',4,'p_return_stmt','ObsidianParser.py',143),
  ('gen_return_quad -> <empty>','gen_return_quad',0,'p_gen_return_quad','ObsidianParser.py',146),
  ...
  ('add_to_pilaOptr -> <empty>','add_to_pilaOptr',0,'p_add_to_pilaOptr','ObsidianParser.py',310),
  ('push_false_bottom -> <empty>','push_false_bottom',0,'p_push_false_bottom','ObsidianParser.py',314),
  ('pop_false_bottom -> <empty>','pop_false_bottom',0,'p_pop_false_bottom','ObsidianParser.py',318),
  ('dm -> MULTIPLICATION','dm',1,'p_dm','ObsidianParser.py',322),
  ('dm -> DIVISION','dm',1,'p_dm','ObsidianParser.py',323),
  ('dm -> MOD','dm',1,'p_dm','ObsidianParser.py',324),
  ('main -> MAIN main_to_proc_dir main_block','main',3,'p_main','ObsidianParser.py',328),
  ('main_to_proc_dir -> <empty>','main_to_proc_dir',0,'p_main_to_proc_dir','ObsidianParser.py',331),
  ('main_block -> LBRACKET more_vars more_statement RBRACKET gen_end_quad','main_block',5,'p_main_block','ObsidianParser.py',338),
  ('gen_end_quad -> <empty>','gen_end_quad',0,'p_gen_end_quad','ObsidianParser.py',340),
]
